...
![Diagrama de classes](images/diagrama_classes.png "Diagrama de classes")

##  Modelo de dados

### Modelo conceitual 

![Modelo Conceitual](images/modelo_conceitual.png "Modelo conceitual.")
...
Migrations do BD está incluso dentro do diretorio app/src/supabase/migrations/
...
| Back-end       | Node.js + Vite + Typescript         |
...
A aplicação SupplyAcustic foi hospedada em uma VPS da Hostinger utilizando a plataforma Coolify para gerenciamento do deploy. O código-fonte do projeto foi conectado ao repositório remoto e implantado diretamente no servidor por meio do sistema de automação da plataforma.

O Coolify ficou responsável pelo processo de build, execução e atualização da aplicação, simplificando o gerenciamento do ambiente e garantindo a disponibilidade do sistema. Após a implantação, o domínio supplyacoustic.phflima.com foi configurado para apontar para a VPS, permitindo o acesso público à aplicação através da internet.
